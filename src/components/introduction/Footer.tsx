        ...
        <Grid container direction="row">
          <Grid item xs={6} direction="column" className={classes.box}>
            <Grid item className={classes.pictureBox}>
              <img
                className={classes.twitterPicture}
                src={`${window.location.origin}/pictures/Twitter_Logo_Blue.png`}
              />
            </Grid>
          ...
          <Grid item xs={6} direction="column" className={classes.box}>
            <Grid item className={classes.pictureBox}>
              <img
                ...
                src={`${window.location.origin}/pictures/calender.png`}
              />
            </Grid>
            <Grid item className={classes.textBox}>
              <h3 className={classes.googleText}>Googleとの連携</h3>
              <p>
                Google calenderとの連携によって
                <br />
                課題がどれだけ溜まっているかを
                <br />
                確認出来ます
